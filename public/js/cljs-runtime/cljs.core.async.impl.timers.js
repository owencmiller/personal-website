...
var i_13696 = (self__.level + (1));
while(true){
if((i_13696 <= (new_level + (1)))){
(update[i_13696] = self__.header);
...
while(true){
if((i <= self__.level)){
var links_13698 = (update[i]).forward;
if((i < x__$2.forward.length)){
(x__$2.forward[i] = (links_13698[i]));
} else {
x__$2.forward.push((((i < links_13698.length))?(links_13698[i]):null));
}

if((i < links_13698.length)){
(links_13698[i] = x__$2);
} else {
links_13698.push(x__$2);
}
...
var i_13708 = (0);
while(true){
if((i_13708 <= self__.level)){
var links_13709 = (update[i_13708]).forward;
if((x__$1 === (((i_13708 < links_13709.length))?(links_13709[i_13708]):null))){
(links_13709[i_13708] = (x__$1.forward[i_13708]));

var G__13710 = (i_13708 + (1));
i_13708 = G__13710;
continue;
} else {
var G__13714 = (i_13708 + (1));
i_13708 = G__13714;
continue;
}
} else {
