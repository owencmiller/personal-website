...
var i__5770__auto___13620 = (0);
while(true){
if((i__5770__auto___13620 < len__5769__auto___13619)){
args_arr__5794__auto__.push((arguments[i__5770__auto___13620]));

var G__13621 = (i__5770__auto___13620 + (1));
i__5770__auto___13620 = G__13621;
continue;
} else {
}
break;
...
/** @this {Function} */
(shadow.util.log.cljs$lang$applyTo = (function (seq13571){
...
var G__13574 = cljs.core.first(seq13571__$2);
var seq13571__$3 = cljs.core.next(seq13571__$2);
var G__13575 = cljs.core.first(seq13571__$3);
var seq13571__$4 = cljs.core.next(seq13571__$3);
var G__13576 = cljs.core.first(seq13571__$4);
var seq13571__$5 = cljs.core.next(seq13571__$4);
var G__13577 = cljs.core.first(seq13571__$5);
var seq13571__$6 = cljs.core.next(seq13571__$5);
var self__5754__auto__ = this;
return self__5754__auto__.cljs$core$IFn$_invoke$arity$variadic(G__13572,G__13573,G__13574,G__13575,G__13576,G__13577,seq13571__$6);
}));

(shadow.util.log.cljs$lang$maxFixedArity = (6));

shadow.util.remove_from_vector = (function shadow$util$remove_from_vector(coll,key){
return cljs.core.persistent_BANG_(cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (v,p__13599){
var vec__13600 = p__13599;
var idx = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__13600,(0),null);
var item = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__13600,(1),null);
