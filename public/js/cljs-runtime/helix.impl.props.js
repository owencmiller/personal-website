...
return name_str.replace(helix.impl.props.camel_regexp,(function (p1__21382_SHARP_,p2__21381_SHARP_){
return p2__21381_SHARP_.toUpperCase();
}));
...
var G__21422 = o;
helix.impl.props.goog$module$goog$object.set(G__21422,k,v);
...
while(true){
if(cljs.core.seq(m)){
var G__21666 = cljs.core.rest(m);
var G__21667 = (function (){var entry = cljs.core.first(m);
...
var G__21514 = o1;
helix.impl.props.goog$module$goog$object.extend(G__21514,o2);
...
return helix.impl.props.into_js_array(cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__21571_SHARP_){
if(cljs.core.map_QMARK_(p1__21571_SHARP_)){
return helix.impl.props.primitive_obj.cljs$core$IFn$_invoke$arity$1(p1__21571_SHARP_);
} else {
return p1__21571_SHARP_;
}
}),style));
} else {
return style;
...
while(true){
if(cljs.core.seq(m)){
var G__21674 = cljs.core.rest(m);
var G__21675 = (function (){var entry = cljs.core.first(m);
...
while(true){
if(cljs.core.seq(m)){
var G__21679 = cljs.core.rest(m);
var G__21680 = (function (){var entry = cljs.core.first(m);
